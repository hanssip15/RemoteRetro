...
export default function ResponsiveSidebar({
  ...
  return (
    <div className={`flex w-full flex-1 overflow-hidden min-h-0 bg-white transition-all duration-300 ${
      isCollapsed ? 'flex-col md:grid md:grid-cols-[1fr_400px]' : 'flex-row md:grid md:grid-cols-[1fr_400px]'
    }`}>
      {/* Left Panel - Mobile: Main Content, Desktop: Left Content */}
      ...
      {/* Right Panel - Mobile: Sidebar, Desktop: Right Content */}
